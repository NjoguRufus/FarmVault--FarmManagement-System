# FarmVault — Comprehensive development journal

**Coverage:** Sunday, January 4th, 2026 through Sunday, April 12th, 2026 (US Eastern calendar grouping; commit timestamps authored in Africa/Nairobi, UTC+3).

**Sources:** Git history for this repository (non-shallow; ~207 commits at time of writing), `git show --stat` on key commits, migration filenames and selected contents. Spec references from `docs/` where noted. No git history exists before January 27th, 2026 — the opening days are documented as **prologue** (no commits).

**Calendar note:** January 4th, 2026 was a **Sunday** in US Eastern Time, not a Monday. The journal opens on that Sunday. The first **Monday** of 2026 was January 5th.

---

## How to read this document

**US Eastern (`America/New_York`):** Section titles use US Eastern civil dates so the narrative reads naturally for Washington, D.C.–area readers. Late-evening work in Nairobi (+0300) sometimes appears on the **previous** US calendar day.

**Ordinal dates:** Headings use American long form with ordinals (e.g. January 27**th**).

**Git silence:** Days with no commits are stated explicitly or folded into short “no commits” spans. No fabricated diffs.

---

## Prologue — Sunday, January 4th, 2026 through Monday, January 26th, 2026

**Repository status:** **No commits** on any of these US Eastern calendar days. Nothing in git can recover file-level diffs for this window.

**Inferred / documentation context:**

- SRS and implementation materials in this repo describe a **KCA**-labeled FarmVault vision and, in older prose, **Firebase Auth + Firestore**. Headers say “Last Updated: February **2025**” — that is **document metadata**, not a git date. Those files **first entered this repository** on **Monday, February 16th, 2026** (US Eastern), with the commit titled `error boundary added`.
- This three-week January window is best read as **pre-repository or pre-push work**: requirements, coursework wrap-up, Firebase-era prototypes, or local experiments not yet committed here.

**Design intent (from specs that later landed in the repo):** Multi-tenant **companies**; roles from company admin through broker/driver/employee; **developer** as platform operator; crop-centric **projects → operations → harvest → sales**; inventory and expenses; audit and feedback surfaces.

**Impact:** When commits begin on **Tuesday, January 27th, 2026**, the team is **materializing** a long-formed product picture into a single Vite/React monorepo with deployment intent.

---

## Tuesday, January 27th, 2026 — eight commits

**Narrative:** **Day one of recorded history:** an empty README placeholder, then a massive **FIRST COMMIT** that is effectively the whole product skeleton.

**What was built (from the tree of the first real commit):**

- **Tooling:** Vite, TypeScript, ESLint, Tailwind / shadcn-style Radix primitives, Recharts, React Router v6, TanStack Query, toasts, react-hook-form + zod patterns.
- **Auth & roles:** `RequireAuth`, `RequireDeveloper`, Clerk-oriented gates.
- **Layout:** `MainLayout`, `AppSidebar`, `TopNavbar`.
- **Core pages:** Dashboard widgets and tables, billing, expenses, harvest/sales, employees, inventory, crop stages, feedback, AI chat entry, login.
- **State:** `AuthContext`, `ProjectContext`, mock-heavy data (`mockData.ts`).

**Commit sequence (messages):** `first commit` → `FIRST COMMIT` → `Second Push` → three × `Intelinking data` → `vercel deployment fixes` → `bg update`.

**Bugs / friction:** Vercel deployment fixes; repeated “Intelinking” suggests first-pass wiring issues.

**Decisions:** Monolith SPA; Vercel as default host; vertical slice before database authority.

---

## Wednesday, January 28th, 2026 — two commits

**Work completed:** Inventory **drawers**; manager dashboard linked with admin and related components.

**Theme:** Role-based operational views begin to feel like one system.

---

## Thursday, January 29th through Sunday, February 1st, 2026

**No commits** recorded.

---

## Monday, February 2nd, 2026 — one commit

**Work completed:** `broer dash` — broker-facing dashboard iteration.

---

## Tuesday, February 3rd, 2026 — one commit

**Work completed:** `broer update` — broker workflow continuation.

---

## Wednesday, February 4th through Thursday, February 5th, 2026

**No commits.**

---

## Friday, February 6th, 2026 — two commits

**Work completed:** `backup, audit,developer daash`; `crop stages, bacups` — operator surfaces, backup/audit language, crop lifecycle.

**Decisions:** Early emphasis on **data durability and oversight** (production-minded).
...
## Sunday, February 8th, 2026 — one commit

**Work completed:** `woring` — low-detail checkpoint.

---

## Monday, February 9th, 2026 — six commits

**Arc:** `fixing of the operations` (twice) → `operations upgrades` → `happy now with operations upgrades` (twice) → `added harvest collections` (timestamp crosses US day boundary).

**Impact:** Operations stabilizes; harvest collections enter the product.

---

## Tuesday, February 10th, 2026 — two commits

**Work completed:** Harvest collections; `frnchbeans harvest` — domain-specific harvest path.

---

## Wednesday, February 11th, 2026 — one commit

**Work completed:** `added harvest collections` — follow-up pass.

---

## Thursday, February 12th through Saturday, February 14th, 2026

**No commits.**

---

## Sunday, February 15th, 2026 — four commits

**Work completed:** `harvests updates`; **error boundary** added (three commits).

**Decisions:** Treat runtime failures as a UX problem, not “refresh the page.”

---

## Monday, February 16th through Wednesday, February 18th, 2026

**No commits** (error-boundary timestamps grouped under February 15th US Eastern).

---

## Thursday, February 19th, 2026 — two commits

**Work completed:** `navbar` (twice).
...
## Saturday, February 21st, 2026 — five commits

**Work completed:** `bottomnavbar fix`; `done`; `fixed`; `pwa support` (twice).

**Decisions:** PWA / installability for mobile field use.

---

## Sunday, February 22nd, 2026 — five commits

**Work completed:** `pwa` (twice); `offline functionality`; `crop progress`; start of `employee update` (crosses into next US bucket).

---

## Monday, February 23rd, 2026 — four commits

**Work completed:** Employee updates; `image add`.

---

## Tuesday, February 24th, 2026 — three commits

**Work completed:** `cropststcard`; `add project moda` (twice).

---

## Wednesday, February 25th through Friday, February 27th, 2026

**No commits.**

---

## Saturday, February 28th, 2026 — six commits

**Work completed:** `tour update and crop stage update`; `own data per company` (twice); `cropstage fixed` (twice); `harvests fixed` (ISO `2026-03-01+03`, US-bucket February 28th).

**Decisions:** **Tenant isolation** (“own data per company”) stated explicitly in commit messages.

---

## Sunday, March 1st through Monday, March 2nd, 2026

**No commits** (aside from harvest fix in previous US bucket).

---

## Monday, March 2nd, 2026 — nine commits

**Work completed:** `updates`; `googe fi` (twice — Google Fit experiments, per message); `tests` (twice); `updates`; `subs` after midnight Nairobi (`2026-03-03T02:02+03`).

**Theme:** Subscriptions thread; external integrations; automated tests.

---

## Tuesday, March 3rd through Wednesday, March 4th, 2026

**No commits** (other than `subs` edge above).

---

## Thursday, March 5th, 2026 — five commits (**Supabase migration wave**)

**High-level change (commit `3a0fda4`, summarized from `git show --stat`):**

- Removed `firebase.json` and large `firebase.rules` — Firestore rules no longer the primary enforcement path in-repo.
- Added Supabase client stack (`supabase.ts`, bootstrap, `ClerkSupabaseTokenBridge`, `db.ts`, `tables.ts`), onboarding routes (`OnboardingPage`, `RequireOnboarding`, `AuthCallbackPage`), Clerk sign-in/up, dev debug tooling.
- Major `AuthContext` rewrite; harvest collections pages updated.
- Documentation burst: `migration-phases.md`, `supabase-mapping.md`, `firebase-audit.md`, invite/onboarding docs.
- Baseline migrations including `20240101000001_farmvault_schema.sql` — header states schema **mirrors Firebase/Firestore** in Postgres.

**Decisions:** Postgres + RLS as system of record; Clerk for identity; migration documented alongside execution.

---

## Friday, March 6th, 2026 — two commits

**Work completed:** `done`; `harvest`.

---

## Saturday, March 7th, 2026 — three commits

**Work completed:** Three × `UPDATES` — post-migration stabilization.
...
## Monday, March 9th, 2026 — two commits

**Work completed:** `employees update` (spans into Tuesday Nairobi).

---

## Tuesday, March 10th, 2026 — four commits

**Work completed:** `project detais` (twice); `done` (twice).

---

## Wednesday, March 11th, 2026 — one commit

**Work completed:** `major updates`.

---

## Thursday, March 12th, 2026 — five commits (**inventory stress**)

**Sequence:** `inventory` → `inventory crushed` (twice) → `inventory crushedit` → `OPERATIONS`.

**Pattern:** Inventory as high-risk module; recovery tied back to operations.
...
## Saturday, March 14th, 2026 — four commits

**Work completed:** Four × `fixed`.

---

## Sunday, March 15th, 2026 — two commits

**Work completed:** Two × `done`.

---

## Monday, March 16th, 2026 — two commits

**Work completed:** `updates`; `deploy` (after midnight Nairobi).

---

## Tuesday, March 17th, 2026 — twenty-six commits (**production setup**)

**Notable messages:**

- `fix: use only supabase JWT template, remove fallback to default Clerk token`
- `fix: correct Clerk import path`
- `fix(invite): migrate to native Clerk-Supabase integration for JWT verification`
- Many `production setup` / `deploy`; `proD FIX`; `settings`.

**Impact:** JWT and invite paths aligned with Supabase RLS reality.

---

## Wednesday, March 18th, 2026 — twelve commits (**Vercel / SEO / app lock**)

**Vercel / static:** Iteration from SPA rewrite exclusions through “remove all rewrites, let Vercel auto-detect Vite config.”

**Domain:** `Fix sitemap domain to farmvault.africa` (twice).

**Security / UX:** `Refactor Quick Unlock… optional PIN lock`; `Implement simple production-ready App Lock with first-time prompt`.

**Other:** `invitesfix`; multiple `Fix`; `fix: simplify sitemap.xml for debugging`.

---

## Thursday, March 19th, 2026 — two commits

**Work completed:** Two × `Fix`.

---

## Friday, March 20th, 2026 — four commits

**Work completed:** `Fix harvest collection naming and creation stability.`; `Update sitemap lastmod dates.`; `Add premium crop-aware scan entry page.`; `Fix`.

---

## Saturday, March 21st, 2026 — one commit

**Work completed:** `Fix`.

---

## Sunday, March 22nd, 2026 — eleven commits

**Work completed:** `Fix`; sitemap domain fixes (twice); eight × `emai farmvault.africa` — email and brand alignment.

---

## Monday, March 23rd through Wednesday, March 25th, 2026

**No commits.**

---

## Thursday, March 26th, 2026 — two commits

**Work completed:** Two × `emai farmvault.africa`.

---

## Friday, March 27th through Saturday, March 28th, 2026

**No commits.**

---

## Sunday, March 29th, 2026 — two commits

**Work completed:** `settings123`; `done`.

---

## Monday, March 30th, 2026 — two commits

**Work completed:** Two × `settings123`.

---

## Tuesday, March 31st, 2026 — two commits
...
## Thursday, April 2nd, 2026 — five commits (**ambassador + notebook + analytics + PDFs**)

**Flagship commit:** `Ambassador console, refer/QR flow, onboarding, analytics and notebook updates` (`a7f8715`).

**Scale:** ~93 files, ~12.7k insertions, ~698 deletions (from `git show --stat`).

**Representative areas:** Ambassador layout and pages (dashboard, earnings, referrals, onboarding, signup/landing, QR); developer referral pages; `SmartRichNotesEditor`, structured notes, attachments, notebook CSS; PDF templates (expenses, harvest, operations, sales); analytics cards/charts and services; multiple `20260402*.sql` migrations (ambassador program, referral RPCs, analytics RPC repairs, etc.).

**Decisions:** Growth (referrals) and intelligence (notebook, exports) alongside core farm ops.

---

## Friday, April 3rd, 2026 — three commits

**Work completed:** Three × `done`.

---

## Saturday, April 4th, 2026 — two commits

**Work completed:** `stpush`; `done`.
...
## Monday, April 6th, 2026 — eight commits

**Work completed:** Eight × `fixes done` (spans into early Tuesday US time).

**Interpretation:** Batch stabilization after large surface-area changes.

---

## Tuesday, April 7th, 2026 — four commits

**Work completed:** Four × `fixes done`.

---

## Wednesday, April 8th, 2026 — seventeen commits (**OneSignal + install funnel**)

**Explicit work:** OneSignal v16 bootstrap; Chrome permission reliability; subscription behavior for existing/new users; notification settings ↔ OneSignal; crash fix (missing `useEffect` import); **feat:** conditional OneSignal notifications **gated by company setting**; push subscriptions standardized to **app domain** + multi-role tags; landing install button → app domain → auth; developer integration cards restyled; several `fixes done`.

**Impact:** Push becomes tenant-governable and environment-consistent.

---

## Thursday, April 9th, 2026 — eleven commits

**Work completed:** Eleven × `fixes done`.

---

## Friday, April 10th through Saturday, April 11th, 2026

**No commits.**

---

## Sunday, April 12th, 2026 — one commit

**Work completed:** `fixes done` — last commit recorded in git at journal compile time.

**Note:** Local working trees may contain additional work (e.g. audit logging, manual payments, soft-delete migrations) not yet committed; track separately once pushed.

---

## Closing synthesis — Q1 2026 in this repository

1. Ship a complete client product quickly (late January).  
2. Deepen field realism (harvest, operations, PWA/offline).  
3. Declare multi-tenancy (“own data per company,” late February).  
4. Migrate authority to Postgres/Supabase (early March) with documentation.  
5. Productionize identity and hosting (mid-March).  
6. Add monetization-adjacent surfaces (premium scan, subscriptions).  
7. Expand growth + intelligence + exports (early April ambassador + PDF + analytics).  
8. Operationalize notifications (mid-April OneSignal hardening).

---

**Cursor / AI-assisted work:** The following section is merged from local Cursor agent transcripts (every `Write` / `StrReplace` path, full user prompts, repo-scoped Shell commands, `Read` lists, sample `Grep` patterns, and tool counts per session). It overlaps the April 2026 stabilization window but is **not** identical to `git` commits.
...
## Appendix — baseline Postgres mirror (from `20240101000001_farmvault_schema.sql`)

**Header (verbatim):** Schema mirrors Firebase/Firestore data model.

**Tables created (names only):** `companies`, `profiles`, `employees`, `projects`, `project_stages`, `stage_notes`, `project_blocks`, `work_logs`, `operations_work_cards`, `expenses`, `season_challenges`, `needed_items`, `inventory_categories`, `suppliers`, `inventory_items`, `inventory_purchases`, `inventory_usage`, `inventory_audit_logs`, `harvests`, `harvest_collections`, `harvest_pickers`, `picker_weigh_entries`, `harvest_payment_batches`, `harvest_wallets`, `collection_cash_usage`, `project_wallet_ledger`, `project_wallet_meta`, `sales`, `feedback`, `audit_logs`, `activity_logs`, `crop_catalog`, `challenge_templates`, `budget_pools`, `subscription_payments`, `company_subscriptions`, `developer_actions_log`, `platform_expenses`, `code_red`, `code_red_messages`, `developer_backups`, `developer_backup_snapshots`, `records_library`, `company_records`, `company_record_shares`, `crops`, `deliveries`, `custom_roles`, `harvest_cash_pools`.

---

*Generated from repository git log and selected `git show --stat` output. Regenerate the git-dated portion by re-running grouping with `America/New_York` on `%aI` timestamps. To refresh the merged Cursor appendix: `node scripts/cursor-transcript-summarize.mjs --markdown --out docs/cursor-sessions-appendix-detailed.md` then `node scripts/merge-cursor-appendix-into-journal.mjs` (optional summary table: add `--summary` to the first command).*
