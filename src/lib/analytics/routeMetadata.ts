...
const ROUTE_RULES: RouteRule[] = [
  ...
  { pattern: '/staff/operations', end: true, meta: { page_name: 'Operations', module_name: 'operations' } },
  ...
  { pattern: '/operations/legacy', end: true, meta: { page_name: 'Operations legacy', module_name: 'operations' } },
  { pattern: '/operations', end: true, meta: { page_name: 'Operations', module_name: 'operations' } },
  ...
  { pattern: '/records', end: true, meta: { page_name: 'Records', module_name: 'notes' } },
  { pattern: '/dashboard', end: true, meta: { page_name: 'Dashboard', module_name: 'dashboard' } },
