...
const PATH_TO_MODULE: Array<{ prefix: string; module: PermissionModule }> = [
  ...
  { prefix: '/farm-work', module: 'operations' },
  ...
  { prefix: '/staff/harvest-sessions', module: 'harvest' },
  { prefix: '/staff/tomato-harvest', module: 'harvest' },
  { prefix: '/staff/harvest', module: 'harvest' },
