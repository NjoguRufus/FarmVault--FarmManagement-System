...
export function ProfitChart({
  ...
  return (
    <div className={cn(glass, className)}>
      <h3 className="text-base font-semibold text-foreground mb-1">Profit per crop</h3>
      <p className="text-xs text-muted-foreground mb-4">Gross from harvest totals minus expenses (per crop group)</p>
      {loading ? (
