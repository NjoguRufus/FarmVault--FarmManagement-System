...
export function AIChatButton() {
  ...
  return (
    <>
      ...
      {/* Chat Panel */}
      {isOpen && (
        <div className="fixed right-2 bottom-[5.25rem] sm:right-4 sm:bottom-[5.5rem] md:bottom-6 md:right-6 z-50 w-[calc(100vw-1rem)] max-w-[21rem] h-[58vh] max-h-[24rem] md:w-96 md:h-[500px] bg-card rounded-2xl shadow-2xl border border-border flex flex-col overflow-hidden animate-fade-in">
          {/* Header */}
          ...
          {/* Context Info */}
          <div className="px-3 py-2 sm:px-4 bg-muted/50 text-xs text-muted-foreground border-b border-border">
            <span>Context: </span>
