-- Final analytics RPC definitions: uuid params + finance/harvest/projects schemas + row_security off.
-- IMPORTANT: This migration runs AFTER 20260402141000. The previous version of this file reintroduced
-- legacy public.expenses / public.harvests / text overloads and broke PostgREST (PGRST202 / PGRST203).
