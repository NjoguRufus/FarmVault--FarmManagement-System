-- Analytics RPCs (SECURITY DEFINER, row_security off): exclude soft-deleted projects, expenses,
-- harvest collections, and harvest rows whose project is archived. Aligns dashboards with Phase 2 RLS.
