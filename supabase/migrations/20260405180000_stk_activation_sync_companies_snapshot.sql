-- STK success path: keep subscription + payment rows as today, and sync core.companies
-- subscription snapshot (subscription_status, access_level, trial_started_at) so dashboards
-- and trial state stay consistent when paying during trial.
...
begin
  ...
  -- Upsert company_subscriptions: override trial / trialing, set active paid period
  ...
  -- Sync canonical company row: end trial, mark paid access, align snapshot columns
