-- PostgREST can keep resolving `get_developer_company_season_challenges` to a uuid signature (overload / stale cache).
-- New name + explicit text arg `p_tenant_key` avoids uuid coercion entirely.
