...
function buildPermissions(preset: string, overrides: Record<string, boolean> | null): Record<string, boolean> {
  const presetMap: Record<string, string[]> = {
    admin: ["dashboard.view","projects.view","projects.create","projects.edit","projects.delete","crop_monitoring.view","crop_monitoring.edit","records.view","records.create","records.edit","inventory.view","inventory.create","inventory.edit","inventory.delete","suppliers.view","suppliers.create","suppliers.edit","expenses.view","expenses.create","expenses.edit","expenses.approve","harvest.view","harvest.create","harvest.edit","harvest_collections.view","harvest_collections.create","harvest_collections.edit","harvest_collections.confirm","harvest_collections.pay","logistics.view","logistics.create","logistics.edit","employees.view","employees.create","employees.edit","employees.suspend","employees.permissions.manage","reports.view","reports.export","financials.view","financials.manage","settings.view","settings.manage"],
    farm_manager: ["dashboard.view","projects.view","projects.create","projects.edit","crop_monitoring.view","crop_monitoring.edit","records.view","records.create","records.edit","inventory.view","inventory.create","inventory.edit","suppliers.view","suppliers.create","suppliers.edit","expenses.view","expenses.create","expenses.edit","expenses.approve","harvest.view","harvest.create","harvest.edit","harvest_collections.view","harvest_collections.create","harvest_collections.edit","harvest_collections.confirm","harvest_collections.pay","logistics.view","logistics.create","logistics.edit","employees.view","reports.view","reports.export","financials.view","settings.view"],
    supervisor: ["dashboard.view","projects.view","crop_monitoring.view","crop_monitoring.edit","records.view","records.create","records.edit","inventory.view","harvest.view","harvest_collections.view","harvest_collections.create","harvest_collections.edit","harvest_collections.confirm","harvest_collections.pay","logistics.view","reports.view"],
    ...
    viewer: ["dashboard.view","projects.view","crop_monitoring.view","records.view","inventory.view","expenses.view","harvest.view","harvest_collections.view","reports.view"],
    custom: [],
  };
