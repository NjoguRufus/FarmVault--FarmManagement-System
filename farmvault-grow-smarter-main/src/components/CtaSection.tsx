      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
        ...
        >
          <div className="glass-dark inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8">
            ...
            <span className="text-xs font-medium text-primary-foreground/80 tracking-wide uppercase font-body">
              Start Free Today
            </span>
          </div>
          ...
          <p className="text-primary-foreground/60 text-lg mb-12 max-w-md mx-auto font-body font-light leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button
              size="lg"
              className="gradient-primary text-primary-foreground btn-luxury rounded-2xl px-10 h-14 text-base font-semibold"
            >
              Get Started Now
